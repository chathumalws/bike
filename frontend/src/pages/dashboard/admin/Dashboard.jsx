...
const Dashboard = () => {
  ...
  const stats = [
    { title: 'Revenue', value: 'Rs.50,000', color: 'bg-green-200' },
    { title: 'Users', value: '1,200', color: 'bg-blue-200' },
    { title: 'Menu Items', value: '50', color: 'bg-yellow-200' },
    { title: 'Orders', value: '500', color: 'bg-purple-200' },
  ];
