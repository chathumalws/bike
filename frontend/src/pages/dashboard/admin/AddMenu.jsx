...
const AddMenu = () => {
 ...
 // https://api.imgbb.com/1/upload?expiration=600&key=${image_hosting_key}
  ...
  return (
    <div className="w-full md:w-[870px] px-4 mx-auto">
      <h2 className="text-2xl font-semibold my-4">
        Upload A New <span className="text-pink">vehical</span>
      </h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="form-control w-full">
            <label className="label" htmlFor="item-name">
              <span className="label-text">vehical name*</span>
            </label>
            <input
              type="text"
              id="item-name"
          ...
          <div className="form-control">
            ...
            <textarea
              ...
              placeholder="Tell the worlds about your ice cream recipe"
            ></textarea>
          </div>
...
//           <div className="form-control">
//             <label className="label" htmlFor="recipe">
//               <span className="label-text">vehical Details</span>
//             </label>
//             <textarea
//               id="recipe"
//               {...register("recipe", { required: true })}
//               className="textarea textarea-bordered h-24"
//               placeholder="Tell the worlds about vehical details"
//             ></textarea>
//           </div>
...
//           <button type="submit" className="btn bg-orange text-white px-6">
//             Add Item <FaUtensils />
//           </button>
//         </form>
//       </div>
