...
//               Vehicle Added to The<span className="text-pink"> Cart</span>
//             </h2>
//           </div>
//         </div>
//       </div>
...
//                       </button>
//                     </td>
//                     <td className="text-white" >Rs.{calculateTotalPrice(item).toFixed(2)}</td>
//                     <td>
//                       <button
...
//             <button className="btn btn-md bg-orange text-white px-8 py-1 mt-3">
...

      {
        ...
        <div className="flex flex-col md:flex-row justify-between items-start my-12 gap-8">
          ...
          <div className="md:w-1/2 space-y-3">
            ...
            <Link to ='/process-checkout'>
            <button className="btn btn-md bg-pink text-white px-8 py-1 mt-3">
              Procceed to Checkout
            </button>
            </Link>
